...
from tkinter import *
 #1 usage new *
def pswd_generator ():
    """Generate a random chorocter (lowercase, Uppercose, digit, or punctuation). """
    global sc 
    n = int(e2.get())
...
f4 = Frame (f)
Label (f4, text="Password Generator", font="conicsans 18").pack(side=LEFT) 
f4. pack (pady=20)
...
e3 = Entry(f3, font="comiesans 14", relief=RAISED, textvariable=sc)
...
b3 = Button(text="REJECT", font= "comicsens 14", bg="white", fg="dark blue", borderwidth=3) 
b3.pack()
